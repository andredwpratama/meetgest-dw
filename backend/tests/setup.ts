...
beforeAll(async () => {
  await env.DB.exec("CREATE TABLE IF NOT EXISTS meetings (id TEXT PRIMARY KEY, title TEXT NOT NULL, raw_transcript TEXT NOT NULL, summary TEXT NOT NULL, created_at INTEGER NOT NULL)");
